<div align="center">
  ...
  <h3 align="center">A CollaborativeRoom for Outstanding people!</h3>

   <div align="center">
     A special thanks to <a href="https://www.youtube.com/@javascriptmastery/videos" target="_blank"><b>JavaScript Mastery</b></a> YouTube for teaching such an expectional state of the art project. Go & join the JSM family now!
    </div>
</div>
...
This repository contains the enchnaced version of the corresponding code to an in-depth tutorial available on YouTube channel, <a href="https://www.youtube.com/@javascriptmastery/videos" target="_blank"><b>JavaScript Mastery</b></a>. 
...
```bash
git clone https://github.com/omer-here/collaborative-room.git
...
Or you may use the env.sample to follow along.
...
## 🚨 Tutorial
I am not affiliated with this course but you may join at will!
